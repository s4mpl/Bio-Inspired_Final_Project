...
from neat import genome, graphs
import copy
import numpy as np


def get_pruned_copy(genome_config):
    ...
    new_genome = genome.DefaultGenome(None)
...
def get_pruned_genes(node_genes, connection_genes, input_keys, output_keys):
    used_nodes = graphs.required_for_output(input_keys, output_keys, connection_genes)
